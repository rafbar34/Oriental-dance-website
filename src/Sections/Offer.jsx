                    ...
                    <div className='flex-col'>
                        <div className='flex flex-col sm:flex-row'>
                            ...
                            <div className='flex sm:w-1/2  justify-start text-white  text-2xl leading-8 '>
                                <div className='mr-5 sm:mr-0'><img src={dancer2} /></div>
                            </div>
                        </div>
                    </div>
                    <div className='flex-col'>
                        <div className='flex mx-10 flex-col sm:flex-row'>
                            <div className='flex  sm:w-1/2 justify-start text-white  text-2xl leading-8 '>
                                <div className=''><img className='rounded-xl' src={dancer} /></div>
                            </div>
                            <div className='flex sm:w-1/2 mx-10 sm:mx-0 sm:ml-16 items-center sm:pl-5  justify-start text-white  text-2xl leading-9 tracking-wide '>
                                <div>
                                    <Flip bottom>
